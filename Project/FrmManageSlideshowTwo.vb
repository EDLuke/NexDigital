...
Public Class FrmManageSlideshowTwo
    ...
    Private Sub MoveUp()
        ...
        If lstSlideShowPics.SelectedIndex > 0 Then
            DataLayer.SwitchSlideShowOrder(SlideShowPicsArrayList(SlideShowPicsArrayList.IndexOf(item) - 2), SlideShowPicsArrayList(SlideShowPicsArrayList.IndexOf(item) - 5), 2)
        End If
    End Sub
    ...
    Private Sub MoveDown()
        ...
        If lstSlideShowPics.SelectedIndex <> lstSlideShowPics.Items.Count - 1 Then
            DataLayer.SwitchSlideShowOrder(SlideShowPicsArrayList(SlideShowPicsArrayList.IndexOf(item) - 2), SlideShowPicsArrayList(SlideShowPicsArrayList.IndexOf(item) + 1), 2)
        End If
    End Sub
End Class